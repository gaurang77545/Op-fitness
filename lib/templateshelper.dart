...
class DatabaseHelper {
  static final _databaseName = "templatehelper.db";
  ...
  static final columncombinedexercise = 'combinedexercise';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE IF NOT EXISTS $table (
            ...
            $columncombinedexercise TEXT  NOT NULL,
  ...
  // All of the methods (insert, query, upcombinedexercise, delete) can also be done using
  ...
  // column values will be used to upcombinedexercise the row.
